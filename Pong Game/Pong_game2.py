...
img_ball = cv2.imread('Images/ball.png', cv2.IMREAD_UNCHANGED)
img_bat1 = cv2.imread('Images/bat1.jpg')
img_game_over = cv2.imread('Images/game_over.JPG')
